...
// Вот тут прям совсем запутанно получилось, не придумал как красиво спавнить и иницииализировать объекты разных типов, не стал даже в отдельный файлы выносить
